...
myArr.unshift(9); //insert element to the start ans shifts all the elements 
console.log(myArr);
...
const newwArr = myArr.join(); //converts an array to the string in the newwArr
console.log(myArr);
console.log(newwArr);
...
const myn1 = myArr.slice(1,3); //returns the part of an array from start index (1) to the end index(3) and end index element is not included 
console.log(myn1);
console.log("B ",myArr);



const myn2 = myArr.splice(1,3); // in splice original array is manipulated but in slice the copy of some element is created 
console.log(myn2); // 1,2,3 
console.log(myArr); // 0,4,true, 'hello'
